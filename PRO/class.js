...
class Hello {
    ...
    die() {
        matrix[this.y][this.x] = 0
        for (var i in helloArr) {
            if (this.x == helloArr[i].x && this.y == helloArr[i].y) {
                helloArr.splice(i, 1);
                break;
            }
        }
...
class arj {
    ...
    eat() {
        ...
        if (newCell) {
            ...
            this.y = newY
            for (var i in Pitbul) {
                if (newX == PitbulArr[i].x && newY == grassEaterArr[i].y) {
                    PitbulArr.splice(i, 5);
                    break;
                }
            }
